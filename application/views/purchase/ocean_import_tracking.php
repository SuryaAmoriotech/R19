                            ...
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="supplier_sss" class="col-sm-4 col-form-label"><?php echo display('Container No');?>
                                       ...
                                       <div class="col-sm-8">                                     
                                               <input type="text"      name="container_no"  required=""  class=" form-control" placeholder='Container No' id=""   />
                                            </div>
                            ...
                            <div class="col-sm-6">
                             ...
                             <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="3" class="form-control" required=""  name="port_of_loading" placeholder="Port of loading" id="bl_number" />
                                    </div>
                                </div>
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="3" class="form-control"  required=""   name="port_of_discharge" placeholder="Port of discharge" id="bl_number" />
                                    </div>
                                </div>
                            </div>
